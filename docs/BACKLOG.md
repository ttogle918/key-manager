...
### VAULT-2 🟠 인증 게이트
- **중요도**: 🟠 High | **스프린트**: S3 | **의존성**: VAULT-1 | **사이즈**: M | **상태**: ✅ 백엔드(pytest 16)+프론트 연결 완료 · ⏳ 브라우저 UX 실검증만 남음(확장 미연결)
...
- **하위 할일**
  ...
  - [ ] ⏳ 브라우저 UX 실검증 (build/tsc/lint/vitest·백엔드 API curl 스모크는 통과; 확장 미연결로 인앱 구동 미검증)
- **테스트 체크리스트**
